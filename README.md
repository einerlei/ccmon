...
- **Manager agent visibility** — shows which specialized agent is currently running in manager-type agents
...
3. Infers agent status by analyzing message history and checking process liveness
